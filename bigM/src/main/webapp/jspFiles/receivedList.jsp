...
<!-- Required meta tags -->
	...
	<link rel="stylesheet" href="../allStyles/mainNicePage.css">
			...
			<div class="row">
				...
				<table class="table table-dark table-hover" style ="margin-top: 5rem;">
				 	 ...
				 	 <tbody class ="table-light">
				 	 	<%
				 	 		//for loop
				 	 		orders = odb.getPlacedOrdersByUserId(user.get_id());
				 	 	...
				 	 	%>
				   		 <tr>
				  		    ...
				  		    <td>
				  		    	<a href='#' class="btn btn-info" role="button">Generate Bill</a>
				  		    </td>
