...
<title>bigM-Place-Your_Order</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
	            ...
	            <div class="col-xl-6">
	             <div class="card-body p-md-5 text-black">
	              ...
	              <form action="../OrderCtrl" method = "post">
	                <h3 class="mb-5 text-uppercase">Adding your order :)</h3>
	
	                <div class="row">
	                  <div class="col-md-6 mb-4">
	                    <div class="form-outline">
	                      <input type="text" name="orderName" class="form-control form-control-lg" value = <%=user.getName() %>>
	                      <label class="form-label" for="form3Example1m">Bill Name:</label>
	                    </div>
	                  </div>
	                  <div class="col-md-6 mb-4">
	                    <div class="form-outline">
	                      <input type="text" name="shopName" class="form-control form-control-lg" value = <%=user.getShopName() %>>
	                ...
	                <div class="row">
	                  <div class="col-md-6 mb-4">
	                    <div class="form-outline">
	                      <input type="text" name = "orderNumber" class="form-control form-control-lg" value=<%=user.getNumber() %> />
	                      <label class="form-label" for="form3Example1m1">Contact Number</label>
	                    </div>
	                  </div>
	                  <div class="col-md-6 mb-4">
	                    <div class="form-outline">
	                      <input type="text" name="productName" class="form-control form-control-lg" value = <%=productName %> readonly />
	                ...
	                <select class="form-select form-select-lg mb-3" name="type" aria-label=".form-select-lg example">
					  <option selected>Plz select the type of Product</option>
	                ...
	                <div class="form-outline mb-4">
	                  <input type="text" name="qty" class="form-control form-control-lg" placeholder="Enter the quantity!!here"/>
	                  <label class="form-label" for="form3Example8"> Quantity</label>
	                </div>
					
					 <div class="form-outline mb-4">
	                  <input type="text" name="description" class="form-control form-control-lg" placeholder="Anything specialization u wanna add u can add it here"/>
	                  <label class="form-label" for="form3Example8"> Description</label>
	                </div>
	                            
	                <div class="form-outline mb-4">
	                  <input type="text" name = "deliveryAddress" class="form-control form-control-lg" value = <%=user.getAddress() %>/>
	                ...
	                <div class="d-flex justify-content-end pt-3">
	                  ...
	                  <button class="btn btn-outline-success btn-submit">Add</button>
	                </div>
